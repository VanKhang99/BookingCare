    ...
    <Carousel className="slides" afterChange={onChange} {...settings}>
      ...
      <div className="slide">
        <div className="slide-content">
          <div className="slide-img">
            <img
              src="https://cdn.bookingcare.vn/fr/w300/2022/11/19/145532-adn-1.png"
              alt=""
            />
          </div>
          <a href="/" className="slide-title">
      ...
      <div className="slide">
        <div className="slide-content">
          <div className="slide-img">
            <img
              src="https://cdn.bookingcare.vn/fr/w300/2022/11/21/153403-consult-now.jpg"
              alt=""
            />
          </div>
          <a href="/" className="slide-title">
      ...
      <div className="slide">
        <div className="slide-content">
          <div className="slide-img">
            <img
              src="https://cdn.bookingcare.vn/fr/w300/2022/11/24/142809-consult-now-5.png"
              alt=""
            />
          </div>
          <a href="/" className="slide-title">
