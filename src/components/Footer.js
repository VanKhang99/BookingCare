    ...
    <footer className="footer-container">
      <div className="u-wrapper">
        <div className="footer">
          <div className="footer-left">
            ...
            <div className="info-company">
              <strong className="info-company__name">{t("footer.company-name")}</strong>
              <div className="info-company__address">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                  <path d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z" />
                </svg>
                <span>28 Thành Thái, Dịch Vọng, Cầu Giấy, Hà Nội</span>
              </div>
              <div className="info-company__business-license">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
              ...
              <div className="info-company__copyright">
          ...
          <div className="footer-right">
            <div className="footer-right-branches">
              <div className="footer-right-branches__headquarter">
                <strong>{t("footer.headquarter-hanoi")}</strong>
                <span>28 Thành Thái, Dịch Vọng, Cầu Giấy, Hà Nội</span>
              </div>
              <div className="footer-right-branches__office">
                <strong>{t("footer.office-hcm")}</strong>
                <span>Số 01, Hồ Bá Kiện, Phường 15, Quận 10</span>
              </div>
              <div className="footer-right-branches__support-link">
        ...
        <div className="footer-download">
          <div className="footer-download__left">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
              <path d="M272 0H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h224c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zM160 480c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm112-108c0 6.6-5.4 12-12 12H60c-6.6 0-12-5.4-12-12V60c0-6.6 5.4-12 12-12h200c6.6 0 12 5.4 12 12v312z" />
            </svg>

            <div className="footer-download__left-text">
              {t("footer.download")}:{" "}
              <a
