    ...
    <section className="media-container u-wrapper u-border-bottom">
      <div className="media">
        ...
        <div className="media-content">
          ...
          <ul className="media-articles">
            <li className="media-article">
              <a
                href="https://suckhoedoisong.vn/dat-lich-kham-benh-tiet-kiem-thong-minh-va-hieu-qua-169153232.htm"
                target="_blank"
                rel="noreferrer"
                className="media-article__link"
              >
                <div
                  className="media-article__link-img"
                  style={{
            ...
            <li className="article">
              ...
              >
                <div
                  className="media-article__link-img img-vtc-news"
                  style={{
            ...
            <li className="article">
              ...
              >
                <div
                  className="media-article__link-img img-vtc"
                  style={{
