...
import { InputSearch, ScrollToTop, Loading } from "../components";
...
const Clinics = () => {
  ...
  useEffect(() => {
    ...
    if (clinics.length) {
      const { alphabetNavigator, clinicsAlphabetOrder } = doClinicArrToRender(clinics);
  ...
  }, [clinicsHavePackages?.length, clinics.length]);
              ...
              <div className="clinics-top u-wrapper" ref={ref}>
                ...
                <div className="clinics-actions">
                  <div className="clinics-actions-filter">
                    <select
                      id="test"
                      className="clinics-actions-filter__list"
                  ...
                  <div className="clinics-actions-search">
                    <InputSearch
                      placeholder={
                        language === "vi" ? "Tìm kiếm cơ sở y tế" : "Search for medical facilities"
                      }
                      icon={<GoSearch />}
