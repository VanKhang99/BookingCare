...
import { inputChange } from "../slices/userSlice";
import { handleChangePathSystem } from "../slices/appSlice";
import { login } from "../slices/userSlice";
import { TIMEOUT_NAVIGATE_SYSTEM } from "../utils/constants";
...
const Login = () => {
  ...
  const handleInputChange = (_, allValues) => {
    dispatch(inputChange(allValues));
  };
  ...
  return (
    <div className="login-background">
      <div className="back-home">
        <button className="back-home-link" onClick={handleBackHomePage}>
          <BiArrowBack />
          Về Trang chủ
        </button>
      </div>
